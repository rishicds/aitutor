            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li><Link href="#" className="text-base text-gray-300 hover:text-white">JEE Preparation</Link></li>
                  <li><Link href="#" className="text-base text-gray-300 hover:text-white">NEET Preparation</Link></li>
                  <li><Link href="#" className="text-base text-gray-300 hover:text-white">CSE Courses</Link></li>
                  <li><Link href="#" className="text-base text-gray-300 hover:text-white">Electrical Engineering</Link></li>
                </ul>
              </div>
