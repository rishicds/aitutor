    ...
    resources: [
      {
        ...
        url: "https://www.therapistaid.com/therapy-worksheet/cognitive-restructuring",
      },
    ...
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.3 }}>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Explore various Cognitive Behavioral Therapy techniques and related approaches
          </CardDescription>
        </CardHeader>
        <CardContent>
