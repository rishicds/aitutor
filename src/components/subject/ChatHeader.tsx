    ...
    <header className="fixed top-0 left-0 right-0 z-10 border-b border-white/10 bg-black/80 backdrop-blur-lg">
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <Link href="/dashboard">
            <motion.div whileHover={{ x: -5 }} className="p-2 rounded-lg hover:bg-white/5 transition-colors">
          ...
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold text-white">{id.charAt(0).toUpperCase() + id.slice(1)} AI Tutor</h1>
          </div>
        </div>
