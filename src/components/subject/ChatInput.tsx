...
export function ChatInput({
  ...
  return (
    <form onSubmit={onSubmit} className="fixed bottom-0 left-0 right-0 bg-black/80 backdrop-blur-lg border-t border-white/10">
      <div className="max-w-5xl mx-auto p-4">
        ...
        {tokens < 1 && (
          <p className="text-red-400 text-sm mt-2">Not enough tokens to continue the conversation</p>
        )}
      </div>
    </form>
  );
