        ...
        <div className={`p-8 space-y-6 bg-white/80 backdrop-blur-md rounded-xl shadow-xl border border-purple-100 transition-all duration-500 
          ...
          <div className="mt-8 space-y-6">
            <div className="rounded-md space-y-4">
              <div className={`relative transition-all duration-300 ${activeField === 'displayName' ? 'transform scale-105' : ''}`}>
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <User className={`h-5 w-5 transition-colors duration-300 ${activeField === 'displayName' ? 'text-purple-600' : 'text-purple-400'}`} />
                </div>
                <input
                  id="display-name"
                  name="displayName"
          ...
          <div className="pt-4 text-center">
            <p className="text-sm text-purple-600">
              ...
              <a href="/signin" className="font-medium text-purple-800 hover:text-purple-900 cursor-pointer hover:underline transition-all">
                Sign in
              </a>
            </p>
          </div>
