...
const tutors = [
  // 🔵 JEE Tutors
  {
    ...
    subject: "Mathematics",
    category: "JEE",
    description: "Expert in calculus, algebra, and trigonometry",
  },
  {
    id: 2,
    name: "Dr. Neha Kapoor",
    subject: "Physics",
    category: "JEE",
    description: "Specialist in mechanics, optics, and thermodynamics",
  },
  {
    id: 3,
  ...
  // 🟢 NEET Tutors
  {
    ...
    subject: "Biology",
    category: "NEET",
    description: "Expert in human anatomy, botany, and zoology",
  },
  {
    id: 5,
    name: "Dr. Rakesh Iyer",
    subject: "Physics",
    category: "NEET",
    description: "Specializes in electromagnetism & nuclear physics",
  },
  {
    id: 6,
    name: "Dr. Kavita Bose",
    subject: "Chemistry",
    category: "NEET",
    description: "Focus on chemical bonding & reaction mechanisms",
  },
  ...
  // 🖥️ CSE Tutors
  {
    ...
    category: "CSE",
    description: "Expert in cryptographic protocols & security algorithms",
  },
  {
    id: 8,
    name: "Dr. David Kumar",
    ...
    category: "CSE",
    description: "Specialist in statistical analysis and visualization",
  },
  {
    id: 9,
    name: "Alex Chen",
    ...
    category: "CSE",
    description: "Focused on deep learning and neural networks",
  },
  {
    id: 10,
          ...
          {filteredTutors.map((tutor, index) => (
            ...
            >
              <div className="relative h-64 w-full">
                <Image
                  src={`https://i.pravatar.cc/720?img=${tutor.id}`}
                  alt={tutor.name}
                  fill
              ...
              <div className="p-6">
                ...
                <div className="mb-4">
                  <span className="inline-block bg-green-900 text-green-400 text-xs font-semibold px-2.5 py-1 rounded">
                    {tutor.category}
                  </span>
                </div>
