...
export default function SignIn() {
  ...
  const updateUserData = async (userId: string, userData: object) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen py-2 bg-gradient-to-br from-purple-50 via-white to-purple-100 relative">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className={`p-8 space-y-6 bg-white/80 backdrop-blur-md rounded-xl shadow-xl border border-purple-100 transition-all duration-500 
          ...
          <div className="text-center relative">
            ...
            <h1 className="text-4xl font-bold text-purple-800 mt-6">Welcome Back</h1>
            <p className="mt-2 text-sm text-purple-600">Sign in to access your account</p>
          </div>
          ...
          <div className="mt-8 space-y-6">
            <div className="rounded-md space-y-4">
              <div className={`relative transition-all duration-300 ${activeField === 'email' ? 'transform scale-105' : ''}`}>
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <Mail className={`h-5 w-5 transition-colors duration-300 ${activeField === 'email' ? 'text-purple-600' : 'text-purple-400'}`} />
                </div>
                <input
                  id="email-address"
                  name="email"
              ...
              <div className={`relative transition-all duration-300 ${activeField === 'password' ? 'transform scale-105' : ''}`}>
                <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none">
                  <Lock className={`h-5 w-5 transition-colors duration-300 ${activeField === 'password' ? 'text-purple-600' : 'text-purple-400'}`} />
                </div>
                <input
                  id="password"
                  name="password"
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <div className="relative">
                  <input
                    ...
                    name="remember-me"
                    type="checkbox"
                    className="h-4 w-4 text-purple-600 focus:ring-purple-500 border-purple-300 rounded opacity-0 absolute"
                  />
                  <div className="bg-white border-2 rounded border-purple-400 w-4 h-4 flex flex-shrink-0 justify-center items-center mr-2 focus-within:border-purple-600">
                    <svg className="fill-current hidden w-3 h-3 text-purple-600 pointer-events-none" viewBox="0 0 20 20">
              ...
              <div className="text-sm">
                <a className="font-medium text-purple-600 hover:text-purple-800 cursor-pointer hover:underline transition-all">
